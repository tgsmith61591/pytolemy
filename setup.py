...
#
# Setup for submodules of pytolemy

"""
Geo-spatial utilities for coordinate pairs
"""
...
# so pytolemy __init__ can detect if it's being loaded in the setup
...
builtins.__PYTOLEMY_SETUP__ = True
...
MAINTAINER = 'Taylor G Smith, Gigi Weingarten'
...
class CleanCommand(clean):
    ...
    # this is mostly in case we ever add a Cython module to pytolemy
    def run(self):
        clean.run(self)
